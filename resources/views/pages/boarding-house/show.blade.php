...
<div id="Content-Container"
        ...
        <main id="Details" class="relative flex flex-col rounded-t-[40px] py-5 pb-[10px] gap-4 bg-white z-10">
            ...
            <div id="Features" class="grid grid-cols-2 gap-x-[10px] gap-y-4 px-5">
                ...
                <div class="flex items-center gap-[6px]">
                    <img src="{{asset('assets/images/icons/security-user.svg') }}" class="w-[26px] h-[26px] flex shrink-0" alt="icon">
                    <p class="text-ngekos-grey">tersedia</p>
                </div>
                <div class="flex items-center gap-[6px]">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="font-semibold">{{$testimonial->created_at}}</p>
                                </div>
                            </div>
