...
<div id="Background"
    ...
    <label class="flex items-center w-full rounded-full p-[14px_20px] gap-3 bg-white focus-within:ring-1 focus-within:ring-[#91BF77] transition-all duration-300 @error('name') border-red-500 @enderror">
        <img src="{{ asset('assets/images/icons/profile-2user.svg') }}" class="w-5 h-5 flex shrink-0" alt="icon">
...
<div class="flex flex-col w-full gap-2 px-5">
    ...
    <label class="flex items-center w-full rounded-full p-[14px_20px] gap-3 bg-white focus-within:ring-1 focus-within:ring-[#91BF77] transition-all duration-300 @error('email') border-red-500 @enderror">
...
<div class="flex flex-col w-full gap-2 px-5">
    ...
    <label class="flex items-center w-full rounded-full p-[14px_20px] gap-3 bg-white focus-within:ring-1 focus-within:ring-[#91BF77] transition-all duration-300 @error('phone') border-red-500 @enderror">
    ...
    <div class="fixed bottom-5 w-full max-w-[640px] px-5 z-10">
        <div class="flex flex-col items-center justify-center rounded-[40px] py-4 px-6 bg-ngekos-black">
            <div class="flex flex-col gap-[2px] items-center">
                <p id="price" class="font-bold text-xl leading-[30px] text-white">
                    <!-- price dari js -->
                </p>
            </div>
            <button type="submit" class="mt-4 flex items-center justify-center rounded-full py-[14px] px-5 bg-ngekos-orange font-bold text-white">Book Now</button>
        </div>
    </div>
</div>
